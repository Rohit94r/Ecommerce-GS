...
export function CommerceProductCard({
  ...
  return (
    <article className="group overflow-hidden rounded-lg border border-slate-200/80 bg-white shadow-sm shadow-slate-900/5 transition duration-300 ease-out hover:-translate-y-1 hover:border-[#047068]/25 hover:shadow-xl hover:shadow-[#047068]/10">
      ...
      <div className="p-5">
        ...
        <div className="mt-4 flex items-end justify-between gap-3">
          ...
          <Button disabled={!product.stock} onClick={() => addItem(toCartProduct(product, category, subcategory))}>
            Add to Cart
          </Button>
        </div>
      </div>
